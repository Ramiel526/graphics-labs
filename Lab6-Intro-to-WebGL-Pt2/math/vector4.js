...
var Vector4 = function(x, y, z, w) {
    ...
    console.assert(this instanceof Vector4, "Vector4 constructor must be called with the 'new' operator");
    ...
    if (!Number.isFinite(this.w)) this.w = 0;
}
...
//----------------------------------------------------------------------------- 
Vector4.fromTo = function(fromPoint, toPoint) {
    return toPoint.clone().subtract(fromPoint);
};

//----------------------------------------------------------------------------- 
Vector4.project = function(vectorToProject, otherVector) {
